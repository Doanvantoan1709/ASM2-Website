      ...
      <div class="card overflow-hidden">
        <div class="card-body">
          <div class="position-relative">
            <img src="/assets/images/carousels/CE.png" class="img-fluid rounded" alt="">
            <div class="position-absolute top-100 start-50 translate-middle">
              <img src="/assets/images/avatars/Toan.png" width="110" height="110" class="rounded-circle raised p-1 bg-white" alt="">
            </div>
          </div>
          <div class="mt-5 d-flex align-items-start justify-content-between">
            <div class="">
              <h3 class="mb-2">Duc Toan</h3>
