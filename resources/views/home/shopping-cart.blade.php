    ...
    <div class="position-center-center">
      <div class="container">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="{{route('home.shop-product')}}">SHOP</a></li>
        ...
        <div class="shopping-cart text-center">
          ...
          <ul class="row cart-details">
            <li class="col-sm-6">
              <div class="media"> 
                <!-- Media Image -->
                <div class="media-left media-middle"> <a href="#." class="item-img"> <img class="media-object" src="/uploads/product/{{ $item->prod->image }}" alt=""> </a> </div>
                
                <!-- Item Name -->
                <div class="media-body">
                  <div class="position-center-center">
                    <h5>{{ $item->prod->name }}</h5>
            ...
            <!-- PRICE -->
            <li class="col-sm-2">
              <div class="position-center-center"> <span class="price">{{ $item->price }}$</span> </div>
            </li>
            <style>
             #addbtn{
            margin-top: 50px
            ...
            <!-- QTY -->
            <li class="col-sm-1">
            <form id="addbtn" action="{{ route('cart.update', $item->product_id) }}" method="get">
            ...
            <!-- TOTAL PRICE -->
            <li class="col-sm-2">
              <div class="position-center-center"> <span class="price">{{ $item->quantity * $item->price }}$</div>
            </li>
            
            <!-- REMOVE -->
            <li class="col-sm-1">
              <div class="position-center-center"> <a href="{{ route('cart.delete', $item->product_id) }}"><i class="icon-close"></i></a> </div>
            </li>
