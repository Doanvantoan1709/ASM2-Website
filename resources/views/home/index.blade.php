      ...
      <div class="tp-banner">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="/assets1/images/slide-bg-1.jpg"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
            <!-- LAYER NR. 1 -->
            ...
            <div class="tp-caption lfb tp-resizeme" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 8;"><a href="{{route('home.shop-product')}}" class="btn">SHOP NOW</a> </div>
          </li>
    ...
    <section class="padding-top-100 padding-bottom-100">
      ...
      <div class="arrival-block single-img-demos"> 
        ...
        <div class="item">
          ...
          <!-- /assets1/images --> 
          <img class="img-1" src="/assets1/images/item-img-1-1.jpg" alt=""> 
          <!-- Overlay  -->
          <div class="overlay"> 
            <!-- Price --> 
        ...
        <div class="item"> 
          <!-- /assets1/images --> 
          <img class="img-1" src="/assets1/images/item-img-1-2.jpg" alt=""> 
          <!-- Overlay  -->
          <div class="overlay"> 
            <!-- Price --> 
            <span class="price"><small>$</small>299</span>
        ...
        <div class="item"> 
          <!-- /assets1/images --> 
          <img class="img-1" src="/assets1/images/item-img-1-3.jpg" alt=""> 
          <!-- Overlay  -->
          <div class="overlay"> 
            <!-- Price --> 
            <span class="price"><small>$</small>299</span>
        ...
        <div class="item"> 
          <!-- /assets1/images --> 
          <img class="img-1" src="/assets1/images/item-img-1-4.jpg" alt=""> 
          <!-- Overlay  -->
          <div class="overlay"> 
            <!-- Price --> 
            <span class="price"><small>$</small>299</span>
        ...
        <div class="item"> 
          <!-- /assets1/images --> 
          <img class="img-1" src="/assets1/images/item-img-1-5.jpg" alt=""> 
          <!-- Overlay  -->
          <div class="overlay"> 
            <!-- Price --> 
            <span class="price"><small>$</small>299</span>
        ...
        <div class="item"> 
          <!-- /assets1/images --> 
          <img class="img-1" src="/assets1/images/item-img-1-6.jpg" alt=""> 
          <!-- Overlay  -->
          <div class="overlay"> 
            <!-- Price --> 
            <span class="price"><small>$</small>299</span>
        ...
        <div class="item"> 
          <!-- /assets1/images --> 
          <img class="img-1" src="/assets1/images/item-img-1-7.jpg" alt=""> 
          <!-- Overlay  -->
          <div class="overlay"> 
            <!-- Price --> 
            <span class="price"><small>$</small>299</span>
        ...
        <div class="item"> 
          <!-- /assets1/images --> 
          <img class="img-1" src="/assets1/images/item-img-1-8.jpg" alt=""> 
          <!-- Overlay  -->
          <div class="overlay"> 
            <!-- Price --> 
            <span class="price"><small>$</small>299</span>
    ...
    <section class="padding-top-50 padding-bottom-150">
      <div class="container"> 
        ...
        <div class="papular-block block-slide single-img-demos"> 
          ...
          <div class="item"> 
            <!-- Item img -->
            <div class="item-img"> <img class="img-1" src="/assets1/images/product-1.jpg" alt="" > 
              <!-- Overlay -->
              <div class="overlay">
                <div class="position-center-center">
          ...
          <div class="item"> 
            <!-- Item img -->
            <div class="item-img"> <img class="img-1" src="/assets1/images/product-2.jpg" alt="" > 
              <!-- Overlay -->
              <div class="overlay">
                <div class="position-center-center">
          ...
          <div class="item"> 
            <!-- Item img -->
            <div class="item-img"> <img class="img-1" src="/assets1/images/product-3.jpg" alt="" > 
              <!-- Overlay -->
              <div class="overlay">
                <div class="position-center-center">
          ...
          <div class="item"> 
            <!-- Item img -->
            <div class="item-img"> <img class="img-1" src="/assets1/images/product-4.jpg" alt="" > 
              <!-- Overlay -->
              <div class="overlay">
                <div class="position-center-center">
    ...
    <div class="container"> 
      ...
      <div class="col-md-3">
        <div class="about-footer"> <img class="margin-bottom-30" src="" alt="" >
          <p><i class="icon-pointer"></i> No. 81 adjacent to 23, Van Canh urban area, <br>   No. 81 adjacent to 23, Van Canh urban area,
</p>
