          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="contact-info">
                <h6>OUR ADDRESS</h6>
                <ul>
                  <li> <i class="icon-map-pin"></i> No. 81 adjacent to 23, Van Canh urban area,<br>
                  Van Canh commune, Hoai Duc district, Hanoi city.</li>
                  <li> <i class="icon-call-end"></i> 0967.327.356</li>
                  <li> <i class="icon-envelope"></i> <a href="mailto:someone@example.com" target="_top">Doanvantoan3365@gmail.com</a> </li>
                  <li>
...
if ($('#map').length) {
	...
	var marker = new google.maps.Marker({
		...
		map: map,
		tittle: 'Envato',
		icon: './/assets1/images/map-locator.png'
	});
} else {
	return false;
}}
