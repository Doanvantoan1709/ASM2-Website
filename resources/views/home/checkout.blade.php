...
<div id="wrap"> 
  ...
  <div id="content"> 
        ...
        <div class="shopping-cart"> 
          ...
          <div class="cart-ship-info">
            <div class="row"> 
              ...
              <div class="col-sm-7">
                ...
                <form action="" method="post">
                  ...
                  <ul class="row">
                    ...
                    <li class="col-md-6">
                      <label> *FULL NAME
                        <input type="text" name="name" value="{{ $auth->name }}" placeholder="Enter name*">
                      </label>
                    </li>
                    ...
                    <li class="col-md-6">     
                      <label>*ADDRESS
                        <input type="text"  name="address" value="{{ $auth->address }}" placeholder="Enter address*">
                      </label>
                    </li>
                    ...
                    <li class="col-md-6">
                      <label> *EMAIL
                        <input type="text" readonly name="email" value="{{ $auth->email }}" placeholder="Enter e-mail*">
                      </label>
                    </li>
                    <!-- PHONE -->
                    <li class="col-md-6">
                      <label> *PHONE
                        <input type="text" name="phone" value="{{ $auth->phone }}" placeholder="Enter phone*">
                      </label>
                    </li>
                  </ul>
              </div>
              ...
              <p>{{ $item->prod->name }} <span>${{ $item->price }}</span></p>
              @endforeach
    ...
    <!-- Display total cost -->
    <p class="all-total">TOTAL COST <span>${{ $totalCost }}</span></p>

    <!-- PLACE ORDER button -->
    <!-- <a href="#." class="btn btn-dark pull-right margin-top-30">acx</a> -->
    <li class="col-md-6">
