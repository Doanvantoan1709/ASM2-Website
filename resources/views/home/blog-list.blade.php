...
<div id="wrap"> 
                  ...
                  <div class="row"> 
                    ...
                    <div class="col-md-5">
                      ...
                      <p>Lorem ipsum dolor sit amet,<br>
                        ...
                        vehicula.</p>
                      <a href="{{route('home.shop-product')}}" class="btn btn-small btn-round">SHOP NOW</a> </div>
                  </div>
                </div>
              </li>
  ...
  <div id="content"> 
      ...
      <div class="container"> 
        ...
        <article> 
          ...
          <div class="post-tittle">
            ...
            <a href="#." class="tittle">THE unique CHAIR BY YunoShop</a> <span>by <strong>admin</strong></span> </div>
          
          <!-- Post Img --> 
          <img class="img-responsive" src="/assets1/images/blog-list-img-1.jpg" alt="" > 
        ...
        <article> 
          ...
          <!-- Post Img --> 
          <img class="img-responsive" src="/assets1/images/blog-list-img-2.jpg" alt="" > 
          <!-- DATE -->
          <div class="media-left">
        ...
        <article> 
          ...
          <!-- Post Img --> 
          <img class="img-responsive" src="/assets1/images/blog-list-img-3.jpg" alt="" > 
          <!-- DATE -->
          <div class="media-left">
        ...
        <article> 
          ...
          <!-- Post Img --> 
          <img class="img-responsive" src="/assets1/images/blog-list-img-4.jpg" alt="" > 
          <!-- DATE -->
          <div class="media-left">
            <div class="post-date"> <span>December</span> <span class="num">27</span> <span class="coments"><i class="icon-bubble primary-color"></i> 06 </span> </div>
          </div>
    ...
    <section class="cultur-block">
      <ul>
        <li> <img src="/assets1/images/cultur-img-1.jpg" alt="" > </li>
        <li> <img src="/assets1/images/cultur-img-2.jpg" alt="" > </li>
        <li> <img src="/assets1/images/cultur-img-3.jpg" alt="" > </li>
        <li> <img src="/assets1/images/cultur-img-4.jpg" alt="" > </li>
      </ul>
