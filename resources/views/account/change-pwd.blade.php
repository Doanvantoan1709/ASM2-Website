...
<div id="wrap"> 
  ...
  <!-- Content -->
     <style>
        #changepwd{
            margin-left: 20px; /* Căn giữa theo chiều ngang */
            width: 686px; /* Độ rộng của phần tử, có thể điều chỉnh tùy ý */
        }
  ...
  <form action="" method="post">
    ...
    <div class="col-md-9 border-right" id="changepwd">
        <div class="p-3 py-5 d-flex flex-column justify-content-between">
            <div>
                ...
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Old Password</label><input type="text" class="form-control" placeholder="enter old password" name="old_password"  required="true"></div>
                    @error('old_password')
                        <small id="TB" class="help-block">{{ $message }}</small>
                    @enderror
                    <div class="col-md-12"><label class="labels">New Password</label><input  type="password" class="form-control" placeholder="enter password" name="password"    required="true"></div>
                    @error('password')
                        <small id="TB" class="help-block">{{ $message }}</small>
                    @enderror
                    <div class="col-md-12"><label class="labels">Confirm Password</label><input type="password" class="form-control" placeholder="enter confirm password" name="confirm_password"    required="true"></div>
